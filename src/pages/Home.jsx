...
const Home = () => {
  const categories = [
    { name: 'تكييف وتبريد', image: 'https://images.unsplash.com/photo-1581093458791-9c3c590618c1?auto=format&fit=crop&w=400&q=80', count: '1.2k منتج', importers: '45 بائع' },
    { name: 'ثلاجات', image: 'https://images.unsplash.com/photo-1571704322040-3bf8f5d0e4a8?auto=format&fit=crop&w=400&q=80', count: '850 منتج', importers: '32 بائع' },
    { name: 'شاشات ذكية', image: 'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=400&q=80', count: '2.4k منتج', importers: '68 بائع' },
    { name: 'غسالات', image: 'https://images.unsplash.com/photo-1626806819282-2c1dc01a5e0c?auto=format&fit=crop&w=400&q=80', count: '640 منتج', importers: '24 بائع' },
    { name: 'طاقة وكهرباء', image: 'https://images.unsplash.com/photo-1509391366360-2e959784a276?auto=format&fit=crop&w=400&q=80', count: '1.1k منتج', importers: '38 بائع' },
    { name: 'سلامة وأمان', image: 'https://images.unsplash.com/photo-1560419015-7c427e8ae5ba?auto=format&fit=crop&w=400&q=80', count: '420 منتج', importers: '15 بائع' },
  ];
      ...
      <section id="categories" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em]">نظام السوق</span>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20">
            <div className="max-w-2xl space-y-4">
              <span className="text-[10px] font-black text-blue-600 uppercase tracking-[0.3em]">مخزون B2B</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            <ProductCard product={{ id: 1, name: "تكييف ذكي احترافي XL", price: 1200, category: "ثلاجات", image: "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?auto=format&fit=crop&w=800&q=80" }} />
            <ProductCard product={{ id: 2, name: "تهوية صناعية 5K", price: 850, category: "تكييف", image: "https://images.unsplash.com/photo-1591189863430-ab87e120f312?auto=format&fit=crop&w=800&q=80" }} />
            <ProductCard product={{ id: 3, name: "شاشة OLED 8K", price: 2100, category: "إلكترونيات", image: "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?auto=format&fit=crop&w=800&q=80" }} />
            <ProductCard product={{ id: 4, name: "غسالة توربو سريعة", price: 450, category: "غسالات", image: "https://images.unsplash.com/photo-1626806819282-2c1dc01a5e0c?auto=format&fit=crop&w=800&q=80" }} />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-20 font-heading">
            <div className="max-w-xl space-y-4">
              <span className="text-[10px] font-black text-yellow-400 uppercase tracking-[0.4em]">الشركاء النخبة</span>
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="px-4 py-1.5 bg-yellow-400/20 border border-yellow-400/30 rounded-full">
                      <span className="text-[10px] font-black text-yellow-400 uppercase tracking-widest">معتمد A+</span>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pb-4 border-b border-white/10">
                    <div>
                      <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">المخزون النشط</p>
                      <p className="text-lg font-black text-yellow-400">{partner.stock}</p>
                    </div>
                    <div>
                      <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">الخبرة</p>
