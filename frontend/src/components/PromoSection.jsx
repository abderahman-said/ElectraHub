...
import { ArrowLeft, Gift, Truck, Shield, Clock } from 'lucide-react';
            ...
            <div className="relative z-10">
                ...
                <div className="flex gap-4">
                  {Object.entries(timeLeft).map(([unit, value]) => (
                    <div key={unit} className="text-center">
                      ...
                      <span className="text-sm text-gray-500 mt-2 capitalize">{unit}</span>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                ...
                >
                  ...
                  <ArrowLeft size={20} className="transform group-hover:translate-x-1 transition-transform duration-300 relative z-10" />
